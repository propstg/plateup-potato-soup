...
namespace blargle.PotatoSoup.custom {
    ...
    public class PotatoSoupMainDish : CustomDish {

        public override string UniqueNameID => "Potato Soup Main Dish";
        ...
        public override List<(Locale, UnlockInfo)> InfoList => new List<(Locale, UnlockInfo)> {
            { (Locale.English, LocalisationUtils.CreateUnlockInfo("Potato Soup", "Now with eventual toppings!", "") )}
        };
